...
import { BACK_URLS, FLASH_MESSAGES, LABORATORY_NAME, ORDER_MOVE_TO_PROCESSING, ORDER_MOVE_TO_REJECTED, TESTS_FAILED, TESTS_NOT_DONE } from "../../constants.js";
...
export default class CellsContextMenu{
    ...
    async createProRejBulkOrders(placementId, extraElement, batchNumber, processing) {
        ...
        this.createProcessingRejectOrders = async (event, processing = false, extraElement) => {
            ...
            if (!this.chosenBatch) {
                ...
                const res = await this.createProRejBulkOrders(
                    this.targetCell.elementData['placement']['placementId'], extraElement, this.chosenBatch, processing
                );
            }
        }
